...
public class FishFoodFragment extends Fragment {
    ...
    private void allResource() {
        ...
        mRecipeSaver.add(new RecipeSaver(R.drawable.dong_po_rou_1080x676, getString(R.string.recipe_dong_po_rou),"","",""));
        mRecipeSaver.add(new RecipeSaver(R.drawable.fish_curry_09718_16x9, getString(R.string.recipe_fish_curry),"","","", 25));
        mRecipeSaver.add(new RecipeSaver(R.drawable.honey_orange_roast_sea_bass_with_lentils,getString(R.string.recipe_honey_orange_roast_sea_bass),"","","", 20));
