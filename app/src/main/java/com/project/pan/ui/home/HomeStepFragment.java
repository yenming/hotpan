...
public class HomeStepFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_home_step, container, false);
        ...
        ViewPager mPager = root.findViewById(R.id.imageViewPager_Step);
